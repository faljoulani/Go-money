    ...
    <section {...attrs} className="relative md:mx-28  xxl:mx-auto max-w-[1440px]">
      ...
      >
        <div className="pointer-events-none md:h-[70%]  xs:h-[100%] absolute inset-0 z-40 md:mt-20 md:left-[170px] xs:left-[27%] ">
          <div className=" translatePhone   md:top-20 flex justify-center">
            <img
              src={phoneSrc}
              alt={phoneAlt}
        ...
        <section className="relative w-full">
          <div className="flex flex-col items-center relative rounded-[30px] overflow-clip bg-black md:h-auto xs:h-auto">
            ...
            <img
              ...
              alt=""
              aria-hidden
              className="pointer-events-none xs:w-full xs:h-[675px] xs:object-fit 
              md:object-cover md:w-full md:h-[60%] select-none absolute left-0 md:top-3 xs:top-0 z-50"
            />
            <img
