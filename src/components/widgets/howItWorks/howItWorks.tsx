...
// Avoid static image imports to prevent sharp requirement at build-time on Windows
      ...
      >
        ...
        <section className="relative w-full">
          ...
          >
            ...
            {/* overlay removed to avoid static assets */}
            {/* pocket lip */}
            {/* pocket image removed to avoid static assets */}
