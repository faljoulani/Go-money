...
export default async function CeoMessage(props: WidgetContext<CardSectionEntity>) {
  ...
  const cardShellCls = isOverlay
    ? 'relative flex md:flex-row xs:flex-col items-center gap-8 bg-white rounded-3xl md:px-24 xs:px-4 rtl:md:px-10 rtl:xs:px-4 pb-10 ring-1 ring-black/5 overflow-hidden'
