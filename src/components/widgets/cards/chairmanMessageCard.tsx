...
export default async function ChairmanMessage(props: WidgetContext<CardSectionEntity>) {
  ...
  return (
    <section {...attributes} className="w-full md:px-20 md:py-16 xs:py-10 max-w-[1440px] xxl:mx-auto">
      <div className="flex md:flex-row xs:flex-col items-center rounded-3xl md:gap-x-8 xs:space-y-4">
        ...
        <div className="text-start md:max-w-[790px] space-y-3">
          ...
          {subtitle && (
            <Description
              className="text-lg text-justify align-middle tracking-normal leading-5 rtl:md:leading-8"
              maxWidth={790}
              html={subtitle}
            ></Description>
          )}
